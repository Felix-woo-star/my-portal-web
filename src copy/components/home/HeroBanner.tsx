...
export function HeroBanner() {
    ...
    const trackBannerClick = (bannerId: string) => {
        const page = typeof window !== "undefined"
            ? `${window.location.pathname}#${bannerId}`
            : `/#${bannerId}`;
        ...
        void fetch("/api/analytics", {
            ...
            // Tracking failures should not affect navigation.
        });
    };
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        {currentBanner.linkUrl ? (
                            <Button asChild size="lg" className="text-lg px-8 py-6 bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_20px_rgba(132,204,22,0.5)] transition-shadow">
                                <a
                                    href={getValidUrl(currentBanner.linkUrl)}
                                    target="_blank"
